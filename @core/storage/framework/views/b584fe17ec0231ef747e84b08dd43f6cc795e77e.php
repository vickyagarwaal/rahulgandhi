                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.license.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" id="verify" class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Verify')); ?></button>
                        </form>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/backend/general-settings/license-settings.blade.php ENDPATH**/ ?>