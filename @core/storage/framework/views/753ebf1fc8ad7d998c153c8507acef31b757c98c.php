            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="order-success-area">
                        <h1 class="title text-center"><?php echo e(get_static_option('product_success_page_title')); ?></h1>
                        <p><?php echo e(get_static_option('product_success_page_description')); ?></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="product-info-wrap">
                                                <h4 class="product-title"><a href="<?php echo e(route('frontend.products.single',['slug'=>$product_info->slug,'id'=>$product_info->id])); ?>"><?php echo e($product_info->title); ?></a></h4>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/frontend/pages/products/product-success.blade.php ENDPATH**/ ?>