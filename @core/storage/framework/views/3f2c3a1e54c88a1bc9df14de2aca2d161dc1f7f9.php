<?php $__env->startSection('section'); ?>
    <div class="dashboard-form-wrapper">
        ...
        <form action="<?php echo e(route('user.profile.update')); ?>" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn-medheal dash-btn width-200 btn-small"><?php echo e(__('Save changes')); ?></button>
        </form>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/frontend/user/dashboard/edit-profile.blade.php ENDPATH**/ ?>