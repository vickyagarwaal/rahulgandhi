            ...
            <div class="col-lg-6 margin-top-80 margin-bottom-120">
                <div class="login-form-wrapper contact-form">
                    ...
                    <form action="<?php echo e(route('user.login')); ?>" method="post" enctype="multipart/form-data" class="contact-page-form style-01" id="login_form_order_page">
                        <?php echo csrf_field(); ?>
                        <div class="error-wrap margin-bottom-10"></div>
                        ...
                        <div class="form-group btn-wrapper">
                            <button type="submit" class="boxed-btn btn-block" id="login_btn"><?php echo e(__('Login')); ?></button>
                        </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/frontend/user/login.blade.php ENDPATH**/ ?>