        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="section-title b-top desktop-center padding-top-25 margin-bottom-55">
                    <h3 class="title"><?php echo e(get_static_option('home_page_popular_product_section_title')); ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
            <?php $__currentLoopData = $all_popular_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/frontend/partials/popular-products.blade.php ENDPATH**/ ?>