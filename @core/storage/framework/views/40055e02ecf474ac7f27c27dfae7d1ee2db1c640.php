...
<?php endif; ?>
                                    ...
                                    <div class="tab-content" >
                                        <?php if(!auth()->check()): ?>
                                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel">
                                                    ...
                                                    <div class="login-form">
                                                        <form action="<?php echo e(route('user.login')); ?>" method="post" enctype="multipart/form-data" class="contact-page-form style-01" id="login_form_order_page">
                                                            ...
                                                            <div class="form-group btn-wrapper">
                                                                <button type="submit" id="login_btn" class="submit-btn btn-medheal"><?php echo e(__('Login')); ?></button>
                                                            </div>
                                                ...
                                                <?php if(!auth()->check()): ?>
                                                    <div class="next-step">
                                                        <button class="next-step-btn btn-medheal" style="display: none" type="button"><?php echo e(__('Next Step')); ?></button>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        <?php endif; ?>
                       ...
                       <div class="cart-total-wrap">
                           ...
                           <div class="form-group manual_payment_transaction_field <?php if(get_static_option('site_default_payment_gateway') == 'manual_payment'): ?> show <?php endif; ?> ">
                            ...
                            <?php endif; ?>
                           <a href="<?php echo e(route('frontend.products.checkout')); ?>" class="btn-medheal cart-view checkout_form_submit_btn"><?php echo e(__('Confirm Order')); ?></a>
                       </div>
                   </div>
                    <?php else: ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/frontend/pages/products/product-checkout.blade.php ENDPATH**/ ?>