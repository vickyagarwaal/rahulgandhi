                    ...
                    <div class="login-form-wrapper contact-form">
                        ...
                        <form action="<?php echo e(route('user.register')); ?>" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                            ...
                            <div class="form-group btn-wrapper">
                                <button class="btn-medheal btn-block" id="register" type="submit"><?php echo e(__('Register')); ?></button>
                            </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/frontend/user/register.blade.php ENDPATH**/ ?>