...
<meta name="og:title" content="<?php echo e($product->og_meta_title); ?>">
<meta name="og:description" content="<?php echo e($product->og_meta_description); ?>">
<?php echo render_og_meta_image_by_attachment_id($product->og_meta_image); ?>
                                ...
                                <div class="single-add-to-card-wrapper">
                                    ...
                                    <?php else: ?>
                                        <form action="<?php echo e(route('frontend.products.add.to.cart')); ?>" method="post">
                                            ...
                                            <button type="submit"
                                                    class="addtocart"><?php echo e(get_static_option('product_single_add_to_cart_text')); ?></button>
                                        </form>
                                    <?php endif; ?>
                                </div>
                                <div class="cat-sku-content-wrapper">
                                    <div class="category-wrap">
                                        <span class="title"><?php echo e(get_static_option('product_single_category_text')); ?></span>
                                        <?php echo get_product_category_by_id($product->category_id,'link'); ?>

                                    </div>
                                    <?php if(!empty($product->sub_category_id)): ?>
                                    <div class="category-wrap">
                                        <span class="title"><?php echo e(get_static_option('product_single_subcategory_text')); ?></span>
                                        <?php echo get_product_category_by_id($product->sub_category_id,'link'); ?>

                                    </div>
                                    <?php endif; ?>
                                    <?php if(!empty($product->sku)): ?>
                                        <div class="sku-wrap"><span
                                                class="title"><?php echo e(get_static_option('product_single_sku_text')); ?></span>
                                            <span class="sku_"><?php echo e($product->sku); ?></span></div>
                                    <?php endif; ?>
                                    <div class="share-wrap">
                                       <ul class="social-icons">
                                           <li class="title"><?php echo e(__('Share')); ?>:</li>
                                           <?php echo single_post_share(route('frontend.blog.single',['slug'=>$product->slug,'id'=>$product->id]),$product->title,$post_img); ?>
                                ...
                                <nav>
                                    <div class="nav nav-tabs" role="tablist">
                                        <a class="nav-item nav-link active" data-toggle="tab" href="#nav-description"
                                           role="tab"
                                           aria-selected="true"><?php echo e(get_static_option('product_single_description_text')); ?></a>
                                        <?php
                                        ...
                                        <?php if(!empty($product_attributes_title[0]) ): ?>
                                            <a class="nav-item nav-link" data-toggle="tab" href="#nav-attributes"
                                               role="tab"
                                               aria-selected="false"><?php echo e(get_static_option('product_single_attributes_text')); ?></a>
                                        <?php endif; ?>
                                        ...
                                        <a class="nav-item nav-link" data-toggle="tab" href="#nav-ratings" role="tab"
                                           aria-selected="false"><?php echo e(get_static_option('product_single_ratings_text')); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </nav>
                                                ...
                                                <?php if(auth()->check()): ?>
                                                    ...
                                                    <form action="<?php echo e(route('product.ratings.store')); ?>" method="post"
                                                        ...
                                                        <div class="btn-wrapper">
                                                            <button type="submit"
                                                                    class="btn-medheal style-01"><?php echo e(__('Submit')); ?></button>
                                                        </div>
                                                    </form>
                                                <?php else: ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="related-product-area">
                            <h3 class="title"><?php echo e(get_static_option('product_single_related_product_text')); ?></h3>
                                    ...
                                    <?php $__currentLoopData = $related_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="col-lg-3">
                                            <div class="single-product-item-3 margin-bottom-30">
                                                <div class="thumb">
                                                    <a href="<?php echo e(route('frontend.products.single',['slug'=>$data->slug,'id'=>$data->id])); ?>">
                                                    ...
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('frontend.products.add.to.cart')); ?>"
                                                           ...
                                                           data-product_quantity="1"><i class="fa fa-shopping-bag"
                                                                                        aria-hidden="true"></i>
                                                            <?php echo e(get_static_option('product_add_to_cart_button_text')); ?>
                ...
                $(document).on('click', '.ajax_add_to_cart', function (e) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            el.html('<i class="fa fa-shopping-bag" aria-hidden="true"></i>' + "<?php echo e(get_static_option('product_add_to_cart_button_text')); ?>");
                            toastr.options = {
                                "closeButton": true,
                                "debug": false,
                                "newestOnTop": false,
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/frontend/pages/products/product-single.blade.php ENDPATH**/ ?>