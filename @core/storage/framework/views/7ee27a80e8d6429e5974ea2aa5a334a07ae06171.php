                ...
                <div class="col-lg-12">
                   ...
                   <div class="cart-wrapper">
                       ...
                       <div class="cart-total-wrap margin-top-30">
                          ...
                          <a href="<?php echo e(route('frontend.products.checkout')); ?>" class="btn-medheal cart-view" id="proceed"><?php echo e(__('Process To Checkout')); ?></a>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/frontend/pages/products/product-cart.blade.php ENDPATH**/ ?>