...
<?php endif; ?>
                        <form action="<?php echo e(route('user.email.verify')); ?>" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                            ...
                            <div class="form-group btn-wrapper text-center">
                                <button type="submit" id="verify" class="boxed-btn"><?php echo e(__('Verify Email')); ?></button>
                            </div>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/frontend/user/email-verify.blade.php ENDPATH**/ ?>