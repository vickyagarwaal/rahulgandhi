        ...
        <?php if(count($product_orders) > 0): ?>
            <div class="table-responsive">
                <table class="table table-striped">
                    <thead>
                    <tr>
                        <th scope="col"><?php echo e(get_static_option('product_page_name')); ?>  <?php echo e(__('Order Info')); ?></th>
                                ...
                                <div class="user-dahsboard-order-info-wrap">
                                    ...
                                    <small class="d-block"><strong><?php echo e(__('Order Status:')); ?></strong>
                                        ...
                                        <?php elseif($data->status == 'shipped'): ?>
                                            <span class="alert alert-custom text-capitalize alert-sm alert-small"><?php echo e(str_replace('_',' ',__($data->status))); ?></span>
                                        <?php elseif($data->status == 'complete'): ?>
                                            <span class="alert alert-custom text-capitalize alert-sm alert-small"><?php echo e(str_replace('_',' ',__($data->status))); ?></span>
                                        <?php else: ?>
                                            <span class="alert alert-custom text-capitalize alert-sm alert-small"><?php echo e(__($data->status)); ?></span>
                                        <?php endif; ?>
                                    </small>
                            ...
                            <td>
                                <?php if($data->payment_status == 'pending' && $data->status != 'cancel'): ?>
                                    ...
                                    <form action="<?php echo e(route('user.dashboard.product.order.cancel')); ?>" method="post">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="order_id" value="<?php echo e($data->id); ?>">
                                        <button type="submit" class="btn btn-sm btn-danger mt-2 mb-2"><?php echo e(__('Cancel')); ?></button>
                                    </form>
                                <?php else: ?>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/rahulgandhi/@core/resources/views/frontend/user/dashboard/product-order.blade.php ENDPATH**/ ?>