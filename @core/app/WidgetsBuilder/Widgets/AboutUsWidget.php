...
class AboutUsWidget extends WidgetBase
{
    public function admin_render()
    {
        ...
        $output .= '<div class="form-group"><textarea name="description"  class="form-control" cols="30" rows="5" placeholder="' . __('Description') . '">' . purify_html($description) . '</textarea></div>';
