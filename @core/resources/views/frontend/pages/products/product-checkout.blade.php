                    ...
                    <div class="checkout-wrapper">
                                                    ...
                                                    <div class="login-form">
                                                        <form action="{{route('user.login')}}" method="post" enctype="multipart/form-data" class="contact-page-form style-01" id="login_form_order_page">
                                                            ...
                                                            <div class="form-group btn-wrapper">
                                                                <button type="submit" id="login_btn" class="submit-btn btn-medheal">{{__('Login')}}</button>
                                                            </div>
                       ...
                       <div class="cart-total-wrap">
                           ...
                           <div class="form-group manual_payment_transaction_field @if(get_static_option('site_default_payment_gateway') == 'manual_payment') show @endif ">
                            ...
                            @endif
                           <a href="{{route('frontend.products.checkout')}}" class="btn-medheal cart-view checkout_form_submit_btn">{{__('Confirm Order')}}</a>
                       </div>
                   </div>
                    @else
