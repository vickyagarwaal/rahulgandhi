            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="order-success-area">
                        <h1 class="title text-center">{{get_static_option('product_success_page_title')}}</h1>
                        <p>{{get_static_option('product_success_page_description')}}</p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="product-info-wrap">
                                                <h4 class="product-title"><a href="{{route('frontend.products.single',['slug'=>$product_info->slug,'id'=>$product_info->id])}}">{{$product_info->title}}</a></h4>
