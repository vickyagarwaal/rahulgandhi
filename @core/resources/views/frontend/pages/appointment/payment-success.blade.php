            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="order-success-area margin-bottom-80">
                        <h1 class="title text-center">{{get_static_option('appointment_booking_success_page_title' )}}</h1>
                        <p>{{get_static_option('appointment_booking_success_page_description')}}</p>
                    </div>
                </div>
                <div class="col-lg-8">
                    ...
                    <ul class="booking_details_list">
                        ...
                        <li><strong>{{__('Free')}}</strong> : {{amount_with_currency_symbol($booking->total)}}</li>
