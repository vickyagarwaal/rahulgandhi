...
@section('site-title')
    {{get_static_option('appointment_page_name')}}
@endsection
@section('page-title')
    {{get_static_option('appointment_page_name')}}
@endsection
                        ...
                        <div class="right-part">
                            <select name="category" class="form-control">
                                ...
                                @foreach($category_list as $category)
                                    <option @if($category->id == $cat_id) selected @endif value="{{$category->id}}">{{$category->name}}</option>
                                @endforeach
                            </select>
                            ...
                            <div class="search-wrapper">
                                <form method="get">
                                    ...
                                    <div class="form-group search-box">
                                        ...
                                        <button class="btn-medheal"><i class="fas fa-search"></i></button>
                                    </div>
                                </form>
                            </div>
                        </div>
