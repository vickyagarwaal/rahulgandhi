...
@section('page-title')
    {{ get_static_option('quote_page_name') }}
@endsection
@section('site-title')
{{ get_static_option('quote_page_name') }}
@endsection
@section('page-meta-data')
    <meta name="description" content="{{get_static_option('quote_page_meta_description')}}">
    <meta name="tags" content="{{get_static_option('quote_page_meta_tags')}}">
@endsection
@section('content') 
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="contact-form style-01 quote-page">
                            <h4 class="title">{{get_static_option('quote_page_form_title')}} </h4>
                            <x-msg.all/>
                            <form action="{{route('frontend.quote.message')}}" method="POST" class="contact-page-form style-01" id="contact_us_form">
                                @csrf
                                    ...
                                    <div class="btn-wrapper text-center">
                                        <button type="submit" class="boxed-btn " id="contact_us_submit_btn">{{get_static_option('quote_page_form_button_text')}} </button>
                                    </div>
                            </form>
                        </div>
                    </div>
