                ...
                <div class="col-lg-12">
                    <div class="user-dashboard-wrapper">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if(request()->routeIs('user.home.product.order')) active @endif" href="{{route('user.home.product.order')}}">{{get_static_option('product_page_name')}} {{__('Orders')}}</a>
                            </li>
                            @if(!empty(get_static_option('product_track_status')))
                                <li class="nav-item">
                                    <a class="nav-link @if(request()->routeIs('user.home.product.order.track') || request()->routeIs('user.home.product.order.track.query')) active @endif" href="{{route('user.home.product.order.track')}}">{{__('Track Your Order')}}</a>
                                </li>
                            @endif
