                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="header-wrapp">
                            <h4 class="header-title">{{__('All Service Categories')}}  </h4>
    ...
    <div class="modal fade" id="category_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('admin.service.category.update')}}" method="post">@csrf
...
<x-btn.save/>
<x-icon-picker.js/>
<x-action.bulk.animate :url="route('admin.service.category.bulk.action')"/>
    <script>
        (function ($){
            "use strict";
            $(document).ready(function () {
                $(document).on('click','.category_edit_btn',function(){
                    ...
                    modal.find('#edit_icon').val(el.data('icon'));
                    modal.find('.edit_icon .icp-dd').attr('data-selected',el.data('icon'));
                    modal.find('.edit_icon .iconpicker-component i').attr('class',el.data('icon'));
