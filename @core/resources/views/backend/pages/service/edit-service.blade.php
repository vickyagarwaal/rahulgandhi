            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.services.update')}}" method="post" enctype="multipart/form-data">@csrf
                            <input type="hidden" name="id" value="{{$service->id}}">
                            <div class="form-group">
                                <label for="title">{{__('Title')}}</label>
                                <input type="text" class="form-control" name="title" value="{{$service->title}}" placeholder="{{__('Title')}}">
                            </div>
                            <div class="form-group">
                                <label>{{__('Description')}}</label>
                                <input type="hidden" name="description" value="{{$service->description}}">
                                <div class="summernote" data-content="{{ $service->description }}">{!! $service->description !!}</div>
                            </div>
                            <div class="form-group">
                                <label for="excerpt">{{__('Excerpt')}}</label>
                                <textarea name="excerpt" cols="30" rows="5" class="form-control">{{$service->excerpt}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="slug">{{__('Slug')}}</label>
                                <input type="text" class="form-control" name="slug" value="{{$service->slug}}" placeholder="{{__('Slug')}}">
                            </div>  
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="og_meta_title" value="{{$service->og_meta_title}}" class="form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea name="og_meta_description" class="form-control" rows="5" id="og_meta_description">{{$service->og_meta_description}}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="meta_tags" class="form-control" data-role="tagsinput"
                                        id="meta_tags" value="{{$service->meta_tags}}" >
                                </div>
                                <div class="form-group col-md-6 col-lg-6">
                                    ...
                                    <div class="media-upload-btn-wrapper">
                                        <div class="img-wrap">
                                            @php
                                                $image = get_attachment_image_by_id($service->og_meta_image,null,true);
                                        ...
                                        <input type="hidden" id="og_meta_image" name="og_meta_image" value="{{$service->og_meta_image}}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" id="category" class="form-control">
                                    ...
                                    @foreach($service_category as $data)
                                        <option @if($service->category_id == $data->id) selected @endif value="{{$data->id}}">{{purify_html($data->name)}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
