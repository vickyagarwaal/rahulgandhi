                    ...
                    <div class="card-body">
                        <div class="header-wrapp">
                            ...
                            <div class="header-title">
                                <a href="{{route('admin.appointment.search')}}" class="btn btn-primary mt-4 pr-4 pl-4" > <i class="fas fa-calendar-plus mr-2"></i> {{__('Book an Appointment')}}</a>
                            </div>
                        </div>
                        <x-bulk-action/>
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.appointment.booking.update')}}"  method="post" id="booking_modal_update_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="booking_time_id">{{__('Booking Time')}}</label>
...
@section('script')
<x-datatable.js/>
<x-action.bulk.animate :url="route('admin.appointment.booking.bulk.action')" />
    <script>
        (function ($){
            "use strict";
