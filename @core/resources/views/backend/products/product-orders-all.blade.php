                                ...
                                @foreach($all_orders as $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{route('admin.products.order.payment.approve',$data->id)}}"  method="post">
                                                @csrf
                                                <button class="btn btn-success mb-2" id="work" type="submit">{{__("Approve Payment")}}</button>
                                            </form>
                                            @endif
            ...
            <div class="modal-content">
                ...
                <form action="{{route('admin.product.order.status.change')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="work" class="btn btn-primary">{{__('Change Status')}}</button>
                    </div>
                </form>
            </div>
        </div>
...
<x-datatable.js/>
<x-btn.work/>
<x-btn.custom :id="'email_send'" :title="__('Working')"/>
    <script>
(function ($){
"use strict";
