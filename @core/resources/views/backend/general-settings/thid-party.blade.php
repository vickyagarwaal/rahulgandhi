                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.general.scripts.settings')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted mt-2">{{__('this code will be load before </head> tag.')}}</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="tawk_api_key">{{__('Tawk.to API Widget Code')}}</label>
                                <textarea name="tawk_api_key" id="tawk_api_key" cols="30" rows="10" class="form-control">{{get_static_option('tawk_api_key')}}</textarea>
                                <small class="form-text text-muted mt-2">{{__('paste the full Tawk.to script.')}}</small>
                            </div>
